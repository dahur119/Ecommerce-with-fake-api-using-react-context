        ...
        <div className='w-full flex flex-col '>
            ...
            <div className= 'flex gap-x-2 h-[36px] text-sm'>
                ...
                <div className='flex flex-1 max-w-[100px] bg-blue-400 items-center h-full border text-primary font-medium'>
                    <div onClick={()=>decreaseAmount(id)} className='flex-1 justify-center items-center cursor-pointer'>
                        <IoMdRemove/>
                    </div>
                ...
                <div className='flex-1 flex justify- items-center text-primary'>{`$ ${parseFloat(price * amount).toFixed(2)}`}</div>
